...
public class SentinelIdentifierListImpl extends ASTWrapperPsiElement implements SentinelIdentifierList {

  public SentinelIdentifierListImpl(@NotNull ASTNode node) {
    super(node);
  }
