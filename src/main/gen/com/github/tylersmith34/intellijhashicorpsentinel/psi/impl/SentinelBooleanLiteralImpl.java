...
public class SentinelBooleanLiteralImpl extends ASTWrapperPsiElement implements SentinelBooleanLiteral {

  public SentinelBooleanLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
