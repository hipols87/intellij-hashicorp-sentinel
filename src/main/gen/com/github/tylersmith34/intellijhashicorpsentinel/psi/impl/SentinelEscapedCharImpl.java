...
public class SentinelEscapedCharImpl extends ASTWrapperPsiElement implements SentinelEscapedChar {

  public SentinelEscapedCharImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitEscapedChar(this);
  }
