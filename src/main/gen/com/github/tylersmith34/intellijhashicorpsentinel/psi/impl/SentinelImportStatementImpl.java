...
public class SentinelImportStatementImpl extends ASTWrapperPsiElement implements SentinelImportStatement {

  public SentinelImportStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
