...
public class SentinelMainRuleImpl extends ASTWrapperPsiElement implements SentinelMainRule {

  public SentinelMainRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitMainRule(this);
  }
