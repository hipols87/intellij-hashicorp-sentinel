...
public class SentinelCaseStmtImpl extends ASTWrapperPsiElement implements SentinelCaseStmt {

  public SentinelCaseStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SentinelCaseWhenClause getCaseWhenClause() {
    return findNotNullChildByClass(SentinelCaseWhenClause.class);
  }

  @Override
  @Nullable
  public SentinelCondition getCondition() {
    return findChildByClass(SentinelCondition.class);
  }
