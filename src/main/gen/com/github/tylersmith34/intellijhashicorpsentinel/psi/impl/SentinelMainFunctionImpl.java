...
public class SentinelMainFunctionImpl extends ASTWrapperPsiElement implements SentinelMainFunction {

  public SentinelMainFunctionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitMainFunction(this);
  }
