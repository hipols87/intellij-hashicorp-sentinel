...
public class SentinelMapDefinitionImpl extends ASTWrapperPsiElement implements SentinelMapDefinition {

  public SentinelMapDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SentinelKeyedElementList getKeyedElementList() {
    return findChildByClass(SentinelKeyedElementList.class);
  }
