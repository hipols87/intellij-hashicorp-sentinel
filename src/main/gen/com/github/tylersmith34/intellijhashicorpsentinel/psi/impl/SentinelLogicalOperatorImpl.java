...
public class SentinelLogicalOperatorImpl extends ASTWrapperPsiElement implements SentinelLogicalOperator {

  public SentinelLogicalOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
