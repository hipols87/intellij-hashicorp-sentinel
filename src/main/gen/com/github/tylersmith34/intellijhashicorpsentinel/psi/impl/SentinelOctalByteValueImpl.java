...
public class SentinelOctalByteValueImpl extends ASTWrapperPsiElement implements SentinelOctalByteValue {

  public SentinelOctalByteValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitOctalByteValue(this);
  }
  ...
  @Override
  @NotNull
  public List<SentinelOctalDigit> getOctalDigitList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SentinelOctalDigit.class);
  }
