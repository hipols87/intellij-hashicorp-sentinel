...
public class SentinelFunctionBodyImpl extends ASTWrapperPsiElement implements SentinelFunctionBody {

  public SentinelFunctionBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SentinelFunctionStatement> getFunctionStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SentinelFunctionStatement.class);
  }

  @Override
  @NotNull
  public SentinelReturnStatement getReturnStatement() {
    return findNotNullChildByClass(SentinelReturnStatement.class);
  }
