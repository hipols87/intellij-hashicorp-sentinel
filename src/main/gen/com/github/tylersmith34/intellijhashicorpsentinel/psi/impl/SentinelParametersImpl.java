...
public class SentinelParametersImpl extends ASTWrapperPsiElement implements SentinelParameters {

  public SentinelParametersImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SentinelIdentifierList getIdentifierList() {
    return findChildByClass(SentinelIdentifierList.class);
  }
