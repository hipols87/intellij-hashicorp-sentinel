...
public class SentinelGlobalVariableDefinitionImpl extends ASTWrapperPsiElement implements SentinelGlobalVariableDefinition {

  public SentinelGlobalVariableDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SentinelVariableDefinition getVariableDefinition() {
    return findNotNullChildByClass(SentinelVariableDefinition.class);
  }
