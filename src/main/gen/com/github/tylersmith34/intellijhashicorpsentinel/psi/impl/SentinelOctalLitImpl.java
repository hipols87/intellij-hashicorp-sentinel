...
public class SentinelOctalLitImpl extends ASTWrapperPsiElement implements SentinelOctalLit {

  public SentinelOctalLitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitOctalLit(this);
  }
