...
public class SentinelListDefinitionImpl extends ASTWrapperPsiElement implements SentinelListDefinition {

  public SentinelListDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SentinelElementList getElementList() {
    return findChildByClass(SentinelElementList.class);
  }
