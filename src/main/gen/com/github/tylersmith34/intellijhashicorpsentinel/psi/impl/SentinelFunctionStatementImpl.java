...
public class SentinelFunctionStatementImpl extends ASTWrapperPsiElement implements SentinelFunctionStatement {

  public SentinelFunctionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
