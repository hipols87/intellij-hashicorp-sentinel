...
public class SentinelHexLitImpl extends ASTWrapperPsiElement implements SentinelHexLit {

  public SentinelHexLitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitHexLit(this);
  }
