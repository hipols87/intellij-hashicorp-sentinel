...
public class SentinelHexByteValueImpl extends ASTWrapperPsiElement implements SentinelHexByteValue {

  public SentinelHexByteValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitHexByteValue(this);
  }
  ...
  @Override
  @NotNull
  public List<SentinelHexDigit> getHexDigitList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SentinelHexDigit.class);
  }
