...
public class SentinelFunctionParametersImpl extends ASTWrapperPsiElement implements SentinelFunctionParameters {

  public SentinelFunctionParametersImpl(@NotNull ASTNode node) {
    super(node);
  }
