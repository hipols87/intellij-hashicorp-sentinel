...
public class SentinelFunctionInputImpl extends ASTWrapperPsiElement implements SentinelFunctionInput {

  public SentinelFunctionInputImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SentinelType> getTypeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SentinelType.class);
  }
