...
public class SentinelBooleanExpressionImpl extends ASTWrapperPsiElement implements SentinelBooleanExpression {
  ...
  @Override
  @NotNull
  public List<SentinelBooleanExpressionSegment> getBooleanExpressionSegmentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SentinelBooleanExpressionSegment.class);
  }
