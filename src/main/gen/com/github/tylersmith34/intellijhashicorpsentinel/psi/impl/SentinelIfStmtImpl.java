...
public class SentinelIfStmtImpl extends ASTWrapperPsiElement implements SentinelIfStmt {

  public SentinelIfStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SentinelIfStmt getIfStmt() {
    return findChildByClass(SentinelIfStmt.class);
  }
