...
public class SentinelFunctionDeclarationImpl extends ASTWrapperPsiElement implements SentinelFunctionDeclaration {

  public SentinelFunctionDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SentinelFunctionInput getFunctionInput() {
    return findNotNullChildByClass(SentinelFunctionInput.class);
  }
