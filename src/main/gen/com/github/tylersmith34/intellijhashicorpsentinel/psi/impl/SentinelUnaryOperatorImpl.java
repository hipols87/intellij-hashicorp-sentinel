...
public class SentinelUnaryOperatorImpl extends ASTWrapperPsiElement implements SentinelUnaryOperator {

  public SentinelUnaryOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
