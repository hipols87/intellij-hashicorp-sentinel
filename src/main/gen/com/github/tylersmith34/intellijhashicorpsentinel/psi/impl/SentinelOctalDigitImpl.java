...
public class SentinelOctalDigitImpl extends ASTWrapperPsiElement implements SentinelOctalDigit {

  public SentinelOctalDigitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitOctalDigit(this);
  }
