...
public class SentinelFunctionCallImpl extends ASTWrapperPsiElement implements SentinelFunctionCall {

  public SentinelFunctionCallImpl(@NotNull ASTNode node) {
    super(node);
  }
