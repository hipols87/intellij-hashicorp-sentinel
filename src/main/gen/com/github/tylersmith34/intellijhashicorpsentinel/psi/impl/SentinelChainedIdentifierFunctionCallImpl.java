...
public class SentinelChainedIdentifierFunctionCallImpl extends ASTWrapperPsiElement implements SentinelChainedIdentifierFunctionCall {

  public SentinelChainedIdentifierFunctionCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitChainedIdentifierFunctionCall(this);
  }
  ...
  @Override
  @NotNull
  public SentinelFunctionCallParameters getFunctionCallParameters() {
    return findNotNullChildByClass(SentinelFunctionCallParameters.class);
  }
