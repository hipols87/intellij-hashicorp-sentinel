...
public class SentinelUnaryExprImpl extends ASTWrapperPsiElement implements SentinelUnaryExpr {

  public SentinelUnaryExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SentinelPrimaryExpr getPrimaryExpr() {
    return findChildByClass(SentinelPrimaryExpr.class);
  }
  ...
  @Override
  @Nullable
  public SentinelUnaryOp getUnaryOp() {
    return findChildByClass(SentinelUnaryOp.class);
  }
