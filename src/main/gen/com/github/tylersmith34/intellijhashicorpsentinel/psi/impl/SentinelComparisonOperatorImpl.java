...
public class SentinelComparisonOperatorImpl extends ASTWrapperPsiElement implements SentinelComparisonOperator {

  public SentinelComparisonOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
