...
public class SentinelExpressionStmtImpl extends ASTWrapperPsiElement implements SentinelExpressionStmt {

  public SentinelExpressionStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
