...
public class SentinelBooleanOperatorsImpl extends ASTWrapperPsiElement implements SentinelBooleanOperators {

  public SentinelBooleanOperatorsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitBooleanOperators(this);
  }
