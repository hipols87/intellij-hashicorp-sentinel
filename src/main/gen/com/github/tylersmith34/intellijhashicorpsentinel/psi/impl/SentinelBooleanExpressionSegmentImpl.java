...
public class SentinelBooleanExpressionSegmentImpl extends ASTWrapperPsiElement implements SentinelBooleanExpressionSegment {

  public SentinelBooleanExpressionSegmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitBooleanExpressionSegment(this);
  }
