...
public class SentinelQuantifierOperatorImpl extends ASTWrapperPsiElement implements SentinelQuantifierOperator {

  public SentinelQuantifierOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitQuantifierOperator(this);
  }
