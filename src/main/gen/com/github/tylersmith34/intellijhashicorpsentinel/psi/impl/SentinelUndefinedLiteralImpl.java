...
public class SentinelUndefinedLiteralImpl extends ASTWrapperPsiElement implements SentinelUndefinedLiteral {

  public SentinelUndefinedLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
