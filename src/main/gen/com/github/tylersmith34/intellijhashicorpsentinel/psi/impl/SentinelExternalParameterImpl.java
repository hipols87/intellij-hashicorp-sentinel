...
public class SentinelExternalParameterImpl extends ASTWrapperPsiElement implements SentinelExternalParameter {

  public SentinelExternalParameterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitExternalParameter(this);
  }
