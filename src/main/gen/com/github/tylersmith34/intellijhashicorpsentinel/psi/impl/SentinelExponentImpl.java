...
public class SentinelExponentImpl extends ASTWrapperPsiElement implements SentinelExponent {

  public SentinelExponentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SentinelDecimals getDecimals() {
    return findNotNullChildByClass(SentinelDecimals.class);
  }
