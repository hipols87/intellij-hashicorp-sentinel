...
public class SentinelContinueStmtImpl extends ASTWrapperPsiElement implements SentinelContinueStmt {

  public SentinelContinueStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
