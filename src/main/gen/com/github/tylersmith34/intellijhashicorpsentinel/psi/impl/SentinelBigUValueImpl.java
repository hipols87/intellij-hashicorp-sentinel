...
public class SentinelBigUValueImpl extends ASTWrapperPsiElement implements SentinelBigUValue {

  public SentinelBigUValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SentinelVisitor visitor) {
    visitor.visitBigUValue(this);
  }
