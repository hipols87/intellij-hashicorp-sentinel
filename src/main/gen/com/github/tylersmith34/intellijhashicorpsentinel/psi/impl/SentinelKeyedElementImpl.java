...
public class SentinelKeyedElementImpl extends ASTWrapperPsiElement implements SentinelKeyedElement {

  public SentinelKeyedElementImpl(@NotNull ASTNode node) {
    super(node);
  }
